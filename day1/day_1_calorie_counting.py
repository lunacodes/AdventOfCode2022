...
input_file: Path = Path("day1_input.txt")
...
def find_largest_calories(input: Path) -> int:
    ...
    # ['3120', '4127', '1830', '1283', '5021', '3569', '3164', '2396',
    # '4367', '2821', '6118', '4450', '1300', '3648', '1933']
    ...
    # [3120, 4127, 1830, 1283, 5021, 3569, 3164, 2396, 4367, 2821, 6118,
    # 4450, 1300, 3648, 1933]
